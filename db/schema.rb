...
ActiveRecord::Schema.define(version: 20200312081904) do
  ...
  create_table "group_accounts", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "group_id"
    t.integer  "account_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_group_accounts_on_account_id", using: :btree
    t.index ["group_id"], name: "index_group_accounts_on_group_id", using: :btree
  end
